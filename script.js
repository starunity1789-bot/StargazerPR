...
document.getElementById('Star-Map-Location').addEventListener('click', () => {
    window.open('https://science.nasa.gov/exoplanet-catalog/kepler-452-b/', '_blank');
});
...
新的身体在生物学意义上是少年个体（深海同盟除外），健康状况良好，不携带任何遗传疾病。你的意识将被载入这个身体，与它完全整合。你将重新开始呼吸，重新开始感知，重新开始使用一套你可能从未使用过的感官。
...
克劳斯，深海同盟技术派驻，三十一岁，轮换合同第二年，专攻密封系统的精密检测，不怎么说话，工作的时候完全不说话，下班之后有时候在休息室坐着看技术文献，有时候对着什么东西发呆，林槐从来没搞清楚过他在发呆的时候在想什么，也没有真的问过，因为他感觉如果他问，克劳斯会用他那种中性的、没有任何情绪信号的方式回答一个他完全听不懂的答案，然后他们两个都会觉得很尴尬。
...
克劳斯点了一下头，然后从口袋里拿出一张名片，推到肯面前，说："你做出原型之后联系我，我有一些深海同盟那边的数据库可能对你有用。"
...
*肯的声学检测方案在三年后完成了原型，被工会技术改进委员会提交给天之塔，最终被采纳为可选检测方式之一。克劳斯在他的第二份驻场合同到期后回了深海同盟，但他留下的那份分析报告被纳入了舱体系统年度维护指引的更新版本。*
...
// ===== 渲染第0条内容（默认显示"灵魂摆渡协定"）=====
immigContent.innerHTML = renderImmigMarkdown(immigData[0].content);
...
immigNav.addEventListener('click', (e) => {
    ...
    // 第三步：渲染对应内容到右侧内容区
    immigContent.innerHTML = renderImmigMarkdown(immigData[index].content);
